...
export default function FormSKTM() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    localStorage.setItem("sktmData", JSON.stringify(form));
  ...
  return (
    <div className="max-w-2xl mx-auto py-10 px-4">
      ...
      <h1 className="text-2xl font-bold text-green-800 mb-2">
        Form Pengajuan Surat Keterangan Tidak Mampu (SKTM)
      </h1>
      <p className="text-sm text-gray-500 mb-6 leading-relaxed">
        Lengkapi formulir berikut untuk mengajukan permohonan surat keterangan
        tidak mampu. Pastikan semua data yang dimasukkan sesuai dengan dokumen
        resmi.
      </p>
